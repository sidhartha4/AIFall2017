    ...
    for element in a:
        ...
        for i in range(0, len(matVal)):
            for kClass in range(0,2):
                findClass[kClass] += math.log(featureLabel[kClass][i][matVal[i]])
...
def naiveBayes(a):
    ...
    for element in a:
        ...
        matVal = element[0]
        for i in range(0, len(matVal)):
            featureLabel[element[1]][i][matVal[i]] += 1
...
def convertToPickle(fileName):
    ...
    for i in range(0,len(yesContentTrain)):
        ...
        image.append(yesContentTrain[i][:-1].count('%')) 
    ...
    for i in range(0,len(noContentTrain)):
        ...
        image.append(noContentTrain[i][:-1].count('%'))
    ...
    for i in range(0,len(yesContentTest)):
        ...
        image.append(yesContentTest[i][:-1].count('%')) 
    ...
    for i in range(0,len(noContentTest)):
        ...
        image.append(noContentTest[i][:-1].count('%')) 
